            ...
            if (nngp) {
                ...
                if (is.null(discrete.theta.alpha.values)) {
                    ...
                    if (!discrete.theta.gibbs) {
                        ...
                        lik <- lik + dinvgamma(discrete.theta.alpha.values, 
                                                   theta.alpha.a, 
                                                   theta.alpha.b, 
                                                   log = T)
            ...
            if (nngp) {
                ...
                if (is.null(discrete.theta.beta.values)) {
                    ...
                    if (!discrete.theta.gibbs) {
                        ...
                        lik <- lik + dinvgamma(discrete.theta.beta.values, 
                                                   theta.beta.a, 
                                                   theta.beta.b, 
                                                   log = T)
